...
# ./configure --with-stdair=/opt/stdair --with-airsched=/opt/airsched
#   --with-sevmgr=/opt/sevmgr --with-airrac=/opt/airrac --with-rmol=/opt/rmol 
#   --with-airinv=/opt/airinv --with-simfqt=/opt/simfqt
#
_EOF
...
do
  ...
  then
    echo ""
    echo "Usage:"
    echo "    \$0 [--prefix=<install_dir>] [--with-stdair=<stdair_install_dir>] [--with-sevmgr=<sevmgr_install_dir>] [--with-airsched=<airsched_install_dir>] [--with-airrac=<airrac_install_dir>] [--with-rmol=<rmol_install_dir>] [--with-airinv=<airinv_install_dir>] [--with-simfqt=<simfqt_install_dir>] [--with-doc | --without-doc] [-n|-N|--norm] [-b|--buildir]"
...
#
CMAKE_CMD="cmake \${PREFIX_OPTION} \${STDAIR_OPTION} \${AIRSCHED_OPTION} \${AIRRAC_OPTION} \${RMOL_OPTION} \${SEVMGR_OPTION} \${AIRINV_OPTION} \${SIMFQT_OPTION} \${LIB_OPTION} \${BUILD_OPTION} \${DOC_OPTION} \${SOURCE_DIR}"
